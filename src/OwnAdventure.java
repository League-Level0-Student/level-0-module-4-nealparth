...
public static void main(String[] args) {
	...
	if(plot==0) {
		...
		int further= JOptionPane.showOptionDialog(null, "Question", "Title", 0, JOptionPane.INFORMATION_MESSAGE, null,
				new String[] { "fantasy", "mystery", "action" }, null);
		int further1= JOptionPane.showOptionDialog(null, "Question", "Title", 0, JOptionPane.INFORMATION_MESSAGE, null,
				new String[] { "Magic", "Mythical Creatures", "Gods" }, null);
	}
	else if(plot==2) {
		int after= JOptionPane.showOptionDialog(null, "Question", "Title", 0, JOptionPane.INFORMATION_MESSAGE, null,
				new String[] { "building", "bridge", "park" }, null);
		int after1= JOptionPane.showOptionDialog(null, "Question", "Title", 0, JOptionPane.INFORMATION_MESSAGE, null,
